...
public class TelaFinanceiroCadastroPagamentoEmprestimo extends JFrame {
	...
	public TelaFinanceiroCadastroPagamentoEmprestimo(int modo_operacao, FinanceiroPagamentoEmprestimo pagamento, Lancamento lancamento_pai, Window janela_pai) {
		...
		painelPrincipal.setLayout(new MigLayout("", "[grow][grow][][]", "[][][][1px][][][][][][][][][][50px:n,grow][]"));
		...
		btnSelecionarPagador.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				}else if(lancamento_pai.getTipo_lancamento() == 1 || lancamento_pai.getTipo_lancamento() == 3) {
					//receita
		...
		btnSelecionarRecebedor.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				 if(lancamento_pai.getTipo_lancamento() == 1 || lancamento_pai.getTipo_lancamento() == 3) {
						//despesa, selecionar I.B
...
GerenciarBancoClientes gerenciar_clientes = new GerenciarBancoClientes();
	...
	public FinanceiroPagamentoEmprestimo getDadosAtualizar(FinanceiroPagamentoEmprestimo pagamento_antigo, Lancamento lancamento_pai) {
		FinanceiroPagamentoEmprestimo pagamento = new FinanceiroPagamentoEmprestimo();
