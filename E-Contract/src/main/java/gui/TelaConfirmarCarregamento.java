...
public class TelaConfirmarCarregamento extends JDialog {
	...
	private JLabel lblProdutoCarregamento, lblDataCarregamento, lblCompradorCarregamento, lblContratoCarregamento,
			lblTransportadorCarregamento, lblVeiculoCarregamento, lblVendedorCarregamento;
	...
	private CadastroNFe nota_fiscal_venda1_carregamento, nota_fiscal_complemento_carregamento,
			nota_fiscal_interna_carregamento;
	...
	public TelaConfirmarCarregamento(int flag_modo_tela, CadastroContrato _contrato_local,
			CadastroContrato.Carregamento _carregamento, Window janela_pai) {
		...
		panel_1.setLayout(new MigLayout("",
				"[150px][117px,grow][6px][65px][23px][7px][31px][10px][62px][4px][170px,grow][9px][100px][5px][169px][147px]",
				"[31px][30px][32px][32px][30px][30px][30px][31px][][18px][30px][][18px][28px][][35.00px][30px][42.00px][][39.00][54.00][17.00]"));
		...
		panel_1.add(lblNewLabel_4_1, "cell 10 8");
		...
		panel_1.add(lblNewLabel_4_1_1, "cell 10 11");
		...
		panel_1.add(lblNewLabel_9_2, "cell 0 13,alignx right,aligny center");
		...
		panel_1.add(entCodigoNFVenda1, "cell 1 13 3 1,grow");
		...
		panel_1.add(lblNewLabel_9_1_1_1_1, "cell 6 13 3 1,alignx right,aligny center");

		entPesoNFVenda1 = new JTextField();
		entPesoNFVenda1.addKeyListener(new KeyAdapter() {
			@Override
		...
		panel_1.add(entPesoNFVenda1, "cell 10 13,grow");

		pesoRomaneio = new JTextField();
		pesoRomaneio.addKeyListener(new KeyAdapter() {
			@Override
			public void keyTyped(KeyEvent e) {
				String caracteres = ".0987654321\b";// lista de caracters que não devem ser aceitos
				String s_valor = "";
		...
		panel_1.add(btnLerNfVenda, "cell 15 13,alignx left,growy");
		...
		panel_1.add(lblNewLabel_9_2_1, "cell 0 10,alignx right,aligny center");
		...
		panel_1.add(entCodigoNFInterna, "cell 1 10 3 1,grow");
		...
		panel_1.add(lblNewLabel_9_1_1_1_1_1, "cell 6 10 3 1,alignx right,aligny center");

		entPesoNFInterna = new JTextField();
		entPesoNFInterna.addKeyListener(new KeyAdapter() {
			@Override
			public void keyTyped(KeyEvent e) {
				String caracteres = ".0987654321\b";// lista de caracters que não devem ser aceitos
				String s_valor = "";
		...
		panel_1.add(entPesoNFInterna, "cell 10 10,grow");
		...
		panel_1.add(btnLerNfInterna, "cell 12 10 3 1,alignx left,growy");
		...
		panel_1.add(lblNewLabel_9_1_1_1_1_3, "cell 12 13,alignx right,aligny center");

		entValorNFVenda1 = new JTextField();
		entValorNFVenda1.addKeyListener(new KeyAdapter() {
			@Override
			public void keyTyped(KeyEvent e) {
				String caracteres = ".0987654321\b";// lista de caracters que não devem ser aceitos
				String s_valor = "";
		...
		panel_1.add(entValorNFVenda1, "cell 14 13,grow");
		...
		panel_1.add(chckBoxNFVenda1NaoAplicavel, "cell 1 11 4 2,alignx left,growy");
		...
		panel_1.add(chckBoxNFInternaNaoAplicavel, "cell 1 8 4 2,alignx left,growy");
		...
		JLabel lblNewLabel_4_1_1_1 = new JLabel("somente ponto");
		lblNewLabel_4_1_1_1.setForeground(Color.YELLOW);
		lblNewLabel_4_1_1_1.setFont(new Font("SansSerif", Font.BOLD | Font.ITALIC, 12));
		panel_1.add(lblNewLabel_4_1_1_1, "cell 10 14");

		JLabel lblNewLabel_4_1_1_1_1_1_1 = new JLabel("somente ponto");
		lblNewLabel_4_1_1_1_1_1_1.setForeground(Color.YELLOW);
		lblNewLabel_4_1_1_1_1_1_1.setFont(new Font("SansSerif", Font.BOLD | Font.ITALIC, 12));
		panel_1.add(lblNewLabel_4_1_1_1_1_1_1, "cell 14 14");
		...
		panel_1.add(lblNewLabel_9_2_2_1_1, "cell 0 15,alignx right");
		...
		panel_1.add(entRemetenteNFVenda1, "cell 1 15 8 1,growx,aligny center");
		...
		panel_1.add(lblNewLabel_9_1_1_1_1_2_1_1, "cell 10 15,alignx right");
		...
		panel_1.add(entDestinatarioNFVenda1, "cell 12 15 4 1,growx,aligny center");
		chckBoxNFComplementoNaoAplicavel.setForeground(Color.WHITE);
		panel_1.add(chckBoxNFComplementoNaoAplicavel, "cell 1 16 3 1,alignx left,growy");
		...
		panel_1.add(lblNewLabel_9_2_2, "cell 0 17,alignx right,aligny center");
		...
		panel_1.add(entCodigoNFComplemento, "cell 1 17 3 1,growx,aligny center");
		...
		panel_1.add(lblNewLabel_9_1_1_1_1_2, "cell 4 17 5 1,alignx right,aligny center");

		entPesoNFComplemento = new JTextField();
		entPesoNFComplemento.addKeyListener(new KeyAdapter() {
			@Override
			public void keyTyped(KeyEvent e) {
				String caracteres = ".0987654321\b";// lista de caracters que não devem ser aceitos
				String s_valor = "";
		...
		panel_1.add(entPesoNFComplemento, "cell 10 17,growx,aligny center");
		...
		panel_1.add(lblNewLabel_9_1_1_1_1_3_1, "cell 12 17,alignx right,aligny center");

		entValorNFComplemento = new JTextField();
		entValorNFComplemento.addKeyListener(new KeyAdapter() {
			@Override
			public void keyTyped(KeyEvent e) {
				String caracteres = ".0987654321\b";// lista de caracters que não devem ser aceitos
				String s_valor = "";
		...
		panel_1.add(entValorNFComplemento, "cell 14 17,growx,aligny center");
		...
		btnLerNfComplemento.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				telaTodasNotasFiscais.setDadosPesquisa(destinatario, "", "Venda", produto,
						entCodigoNFComplemento.getText());
				telaTodasNotasFiscais.habilitarBtnSelecionar();
				telaTodasNotasFiscais.pesquisar_notas();
		...
		panel_1.add(btnLerNfComplemento, "cell 15 17,grow");

		JLabel lblNewLabel_4_1_1_1_1 = new JLabel("somente ponto");
		lblNewLabel_4_1_1_1_1.setForeground(Color.YELLOW);
		lblNewLabel_4_1_1_1_1.setFont(new Font("SansSerif", Font.BOLD | Font.ITALIC, 12));
		panel_1.add(lblNewLabel_4_1_1_1_1, "cell 10 18");

		JLabel lblNewLabel_4_1_1_1_1_1 = new JLabel("somente ponto");
		lblNewLabel_4_1_1_1_1_1.setForeground(Color.YELLOW);
		lblNewLabel_4_1_1_1_1_1.setFont(new Font("SansSerif", Font.BOLD | Font.ITALIC, 12));
		panel_1.add(lblNewLabel_4_1_1_1_1_1, "cell 14 18");
		...
		panel_1.add(lblNewLabel_9_2_2_1, "cell 0 19,alignx right");
		...
		panel_1.add(entRemetenteNFComplemento, "cell 1 19 8 1,growx,aligny center");
		...
		panel_1.add(lblNewLabel_9_1_1_1_1_2_1, "cell 9 19 2 1,alignx right");
		...
		panel_1.add(entDestinatarioNFComplemento, "cell 12 19 4 1,growx,aligny center");

		JLabel lblNewLabel_4 = new JLabel("Observação:");
		lblNewLabel_4.setFont(new Font("SansSerif", Font.PLAIN, 16));
		lblNewLabel_4.setForeground(Color.WHITE);
		panel_1.add(lblNewLabel_4, "cell 0 20,alignx right,aligny top");
		...
		panel_1.add(textAreaObs, "cell 1 20 13 2,grow");
		...
		painelConfirmar.setLayout(new MigLayout("",
				"[105px][1px][1px][1px][185px][9px][53px][6px][35px][11px][90px][15px][46px][4px][6px][6px][77px][10px][302px]",
				"[32px][32px][34px][32px][24.00px][99.00px][29.00px][102.00px][29.00px][91.00px][27.00px][55px][23px]"));
		...
		btnSalvar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				// CadastroContrato.Carregamento carregamento_a_inserir = new
				// CadastroContrato.Carregamento();
				CadastroContrato.Carregamento carregamento_a_inserir = getCarregamentoSalvar(new Carregamento());

				CadastroContrato.Carregamento duplicado = gerenciar
						.procurarDuplicataCarregamento(carregamento_a_inserir.getCodigo_romaneio());
				if (duplicado != null) {
					JOptionPane.showMessageDialog(isto,
							"Já Existe um carregamento associado a este código de romaneio!");

					if (JOptionPane.showConfirmDialog(isto, "Abrir", "Deseja ver o carregamento?",
							JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE) == JOptionPane.YES_OPTION) {

						CadastroContrato contrato_selecionado = new GerenciarBancoContratos()
								.getContrato(duplicado.getId_contrato());
					...
					boolean nf_venda1_duplicada = false;
					boolean nf_complemento_duplicada = false;
					boolean nf_interna_duplicada = false;

					if (carregamento_a_inserir.getNf_venda1_aplicavel() == 1 && carregamento_a_inserir.getCodigo_nf_venda1() != null
							&& carregamento_a_inserir.getCodigo_nf_venda1().length() > 0) {

						CadastroContrato.Carregamento duplicado_nf_venda1 = gerenciar
								.procurarDuplicataCarregamentoNFVenda1(carregamento_a_inserir.getCodigo_nf_venda1());

						if (duplicado_nf_venda1 != null) {
							nf_venda1_duplicada = true;

							JOptionPane.showMessageDialog(isto,
									"Já Existe um carregamento associado a este código de NF de Venda!");
							...
							if (JOptionPane.showConfirmDialog(isto, "Abrir", "Deseja ver o carregamento?",
								...
								CadastroContrato contrato_selecionado = new GerenciarBancoContratos()
										.getContrato(duplicado_nf_venda1.getId_contrato());
								TelaGerenciarContrato gerenciar_contrato = new TelaGerenciarContrato(
										contrato_selecionado, isto);
								gerenciar_contrato.setTela(2);
					...
					if (carregamento_a_inserir.getNf_complemento_aplicavel() == 1 && carregamento_a_inserir.getCodigo_nf_complemento() != null
							&& carregamento_a_inserir.getCodigo_nf_complemento().length() > 0) {

						CadastroContrato.Carregamento duplicado_nf_complemento = gerenciar
								.procurarDuplicataCarregamentoNFComplemento(carregamento_a_inserir.getCodigo_nf_complemento());

						if (duplicado_nf_complemento != null) {
							nf_complemento_duplicada = true;

							JOptionPane.showMessageDialog(isto,
									"Já Existe um carregamento associado a este código de NF de Complemento!");
							...
							if (JOptionPane.showConfirmDialog(isto, "Abrir", "Deseja ver o carregamento?",
								...
								CadastroContrato contrato_selecionado = new GerenciarBancoContratos()
										.getContrato(duplicado_nf_complemento.getId_contrato());
								TelaGerenciarContrato gerenciar_contrato = new TelaGerenciarContrato(
										contrato_selecionado, isto);
								gerenciar_contrato.setTela(2);
					...
					if (carregamento_a_inserir.getNf_interna_aplicavel() == 1 && carregamento_a_inserir.getCodigo_nf_interna() != null
							&& carregamento_a_inserir.getCodigo_nf_interna().length() > 0) {

						CadastroContrato.Carregamento duplicado_nf_interna = gerenciar
								.procurarDuplicataCarregamentoNFInterna(carregamento_a_inserir.getCodigo_nf_interna());

						if (duplicado_nf_interna != null) {
							nf_interna_duplicada = true;

							JOptionPane.showMessageDialog(isto,
									"Já Existe um carregamento associado a este código de NF Interna!");
							...
							if (JOptionPane.showConfirmDialog(isto, "Abrir", "Deseja ver o carregamento?",
								...
								CadastroContrato contrato_selecionado = new GerenciarBancoContratos()
										.getContrato(duplicado_nf_interna.getId_contrato());
								TelaGerenciarContrato gerenciar_contrato = new TelaGerenciarContrato(
										contrato_selecionado, isto);
								gerenciar_contrato.setTela(2);
					...
					if (nf_venda1_duplicada || nf_complemento_duplicada || nf_interna_duplicada) {
						
					} else {

						int retorno = gerenciar.inserirCarregamento(contrato_local.getId(), carregamento_a_inserir);
						if (retorno > 0) {
		...
		btnAtualizar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				CadastroContrato.Carregamento duplicado = gerenciar
						.procurarDuplicataCarregamento(carregamento_a_atualizar.getCodigo_romaneio());
				if (duplicado != null) {
				...
				if (prosseguir || prosseguir_mesmo_duplicado) {
					...
					if (atualizou) {
						...
						JOptionPane.showMessageDialog(isto,
								"Erro ao atualizar o carregamento\nConsulte o Administrador");
						isto.dispose();
	...
	public void atualizarDadosConfirmar() {
		...
		if (transportador_carregamento != null) {
			if (transportador_carregamento.getTipo_pessoa() == 0) {
				lblTransportadorCarregamento.setText(transportador_carregamento.getNome_empresarial());
			} else {
				lblTransportadorCarregamento.setText(transportador_carregamento.getNome_fantaia());
			}
			...
			for (CadastroCliente.Veiculo veiculo : transportador_carregamento.getVeiculos()) {
				if (veiculo.getId_veiculo() == id_veiculo) {
					...
					lblVeiculoCarregamento.setText(
		...
		if (!chckBoxNFVenda1NaoAplicavel.isSelected()) {
			if (nota_fiscal_venda1_carregamento != null) {
				...
				if (checkString(entValorNFVenda1.getText())) {
					texto = texto + " Valor: "
							+ NumberFormat.getCurrencyInstance(ptBr).format(new BigDecimal(entValorNFVenda1.getText()));
	...
	public void gerarPastasEArquivos() {
		...
		File diretorio_este_carregamento_contrato1 = new File(
				caminho_diretorio1 + "\\carregamentos" + "\\carregamento_" + carregamento_global.getId_carregamento());
		...
		File diretorio_este_carregamento_contrato2 = new File(
				caminho_diretorio2 + "\\carregamentos" + "\\carregamento_" + carregamento_global.getId_carregamento());
		...
		if (romaneio_carregamento != null) {
			...
			if (pasta_carregamento_contrato1_existe) {
				...
				try {
					...
					boolean copiar = manipular.copiarNFe(servidor_unidade + url_final,
							diretorio_este_carregamento_contrato1.getAbsolutePath() + "\\"
			...
			if (pasta_carregamento_contrato2_existe) {
				try {
					boolean copiar = manipular.copiarNFe(servidor_unidade + url_final,
							diretorio_este_carregamento_contrato2.getAbsolutePath() + "\\"
									+ conteudo[conteudo.length - 1]);
	...
	public CadastroContrato.Carregamento getCarregamentoSalvar(Carregamento carregamento_a_inserir) {
		...
		if (!chckBoxNFVenda1NaoAplicavel.isSelected()) {
			if (nota_fiscal_venda1_carregamento != null) {
				...
				carregamento_a_inserir
						.setNome_destinatario_nf_venda1(nota_fiscal_venda1_carregamento.getNome_destinatario());
		...
		if (!chckBoxNFComplementoNaoAplicavel.isSelected()) {
			if (nota_fiscal_complemento_carregamento != null) {
				...
				// remetente e destinatario
				carregamento_a_inserir
						.setNome_remetente_nf_complemento(nota_fiscal_complemento_carregamento.getNome_remetente());
				carregamento_a_inserir.setNome_destinatario_nf_complemento(
						nota_fiscal_complemento_carregamento.getNome_destinatario());
	...
	public CadastroContrato.Carregamento getCarregamentoAtualizar(Carregamento carregamento_a_inserir) {
		...
		if (!chckBoxNFVenda1NaoAplicavel.isSelected()) {
			if (nota_fiscal_venda1_carregamento != null) {
				...
				// remetente e destinatario
				carregamento_a_inserir
						.setNome_destinatario_nf_venda1(nota_fiscal_venda1_carregamento.getNome_remetente());
				carregamento_a_inserir
						.setNome_destinatario_nf_venda1(nota_fiscal_venda1_carregamento.getNome_destinatario());
	...
	public void rotinasEdicao() {
			...
			if (checkString(carregamento_global.getCodigo_romaneio())) {
				...
				if (checkString(carregamento_global.getCaminho_romaneio())) {
					...
					CadastroRomaneio romaneio = manipular
							.filtrar(new File(servidor_unidade + carregamento_global.getCaminho_romaneio()));
		...
		try {
			...
			if (carregamento_global.getId_transportador() > 0) {
				CadastroCliente transportador = gerenciar_clientes
						.getCliente(carregamento_global.getId_transportador());

				if (carregamento_global.getId_veiculo() > 0) {
					CadastroCliente.Veiculo veiculo = gerenciar_clientes
							.getVeiculo(carregamento_global.getId_veiculo());
				...
				if (checkString(carregamento_global.getCodigo_nf_venda1())) {
					if (carregamento_global.getCaminho_nf_venda1().length() > 10) {
						...
						CadastroNFe nota_fiscal_venda = manipular
								.filtrar(new File(servidor_unidade + carregamento_global.getCaminho_nf_venda1()));
						...
						if (checkString(carregamento_global.getNome_destinatario_nf_venda1().toString()))
							entDestinatarioNFVenda1
									.setText(carregamento_global.getNome_destinatario_nf_venda1().toString());
				...
				if (checkString(carregamento_global.getCodigo_nf_interna())) {
					if (carregamento_global.getCaminho_nf_interna().length() > 10) {
						...
						CadastroNFe nota_fiscal_remessa = manipular
								.filtrar(new File(servidor_unidade + carregamento_global.getCaminho_nf_interna()));
			...
			try {
				...
				if (carregamento_global.getCaminho_nf_complemento().length() > 10) {
					...
					CadastroNFe nota_fiscal_complemento = manipular
							.filtrar(new File(servidor_unidade + carregamento_global.getCaminho_nf_complemento()));
