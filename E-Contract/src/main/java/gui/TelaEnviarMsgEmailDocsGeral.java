...
public class TelaEnviarMsgEmailDocsGeral extends JFrame {
	...
	private JCheckBox chkAnexarContrato;
	private JComboBox cBEmailRemetente;
	private String nome_comprador_global, mensagem_anexo, mensagem_envio_contador, mensagem_notificacao,
			mensagem_assinatura, mensagem_assunto, mensagem_saudacao;
	...
	public TelaEnviarMsgEmailDocsGeral(int flag_tipo_envio, String url, Window janela_pai) {
		...
		painelPrincipal.setLayout(new MigLayout("", "[168px][6px][348px,grow][][12px][100px][12px][342px]", "[35px][29px][33px][37px][33px][220px][86px][23px][37px]"));
		...
		painelPrincipal.add(entEmailDestino, "cell 2 2,growx");
	...
	public void enviar_email() {
		...
		if (rdLivre.isSelected()) {
			...
			String destinatario = entEmailDestino.getText();
