...
public class TelaFinanceiroPagamento extends JFrame {
	...
	public TelaFinanceiroPagamento(int flag_modo_operacao, int flag_retorno, Window janela_pai) {
		...
		panel_1.setBackground(Color.WHITE);
		 panel_1.setLayout(new MigLayout("", "[116px][119px][140px][441px][113px][19px][125px][8px][141px]", "[28px][33px][33px]"));
...
private final int id = 0;
		private final int tipo_FinanceiroPagamentoCompleto = 1;	
		...
		*/
		  ...
		  String data_inicial_filtrar_data_FinanceiroPagamentoCompleto = menorDataPagamento.getText().replace(" ", "");
		    ...
		    if(checkString(data_inicial_filtrar_data_FinanceiroPagamentoCompleto) && checkString(data_final_filtrar_data_FinanceiroPagamentoCompleto) ) {
		...
		if(entNomeRecebedor.getText() != null) {
			...
			if(checkString(entNomeRecebedor.getText())) {
				...
				filters.add(RowFilter.regexFilter(s_nome_recebedor, 5));
			}
		}
...
public boolean checkString(String txt) {
	...
	public class PagamentoTableModel extends AbstractTableModel {
		...
		private final ArrayList<FinanceiroPagamentoCompleto> dados = new ArrayList<>();// usamos como dados uma lista genérica de
																			// nfs
	...
	public ArrayList<FinanceiroPagamentoCompleto> getFinanceiroPagamentoCompletosSelecionado() {
		...
		ArrayList<FinanceiroPagamentoCompleto> FinanceiroPagamentoCompletos_selecionados = new ArrayList<>();
			...
			for(int i = 0; i < linhas_selecionadas.length; i++) {
				...
				int indice = tabela_pagamento.getRowSorter().convertRowIndexToModel(linhas_selecionadas[i]);//converte pro indice do model				
					FinanceiroPagamentoCompleto FinanceiroPagamentoCompleto_selecionado = lista_FinanceiroPagamentoCompletos.get(indice);
