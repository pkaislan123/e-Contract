...
public class TelaFinanceiroCadastroEmprestimo extends JDialog {

	private final JPanel painelPrincipal = new JPanel();
	private final JPanel painelOdin = new JPanel();

	private TelaFinanceiroCadastroEmprestimo isto;
	private JDialog telaPai;
	private final JButton btnCadastrar = new JButton("Cadastrar");
	private final JButton btnAtualizar = new JButton("Atualizar");
	private final JPanel painelTitulo = new JPanel();
	private final JLabel lblNewLabel = new JLabel("Cadastro de Empréstimo");
	...
	private final JLabel lblNewLabel_4 = new JLabel("Mutuante:");
	...
	private final JLabel lblNewLabel_4_1 = new JLabel("Objeto do Empréstimo");
	...
	private final JLabel lblNewLabel_4_1_1 = new JLabel("Valores:");
	...
	private final JRadioButton rdbtnEmprestimo = new JRadioButton("Empréstimo");
	...
	private final JLabel lblNewLabel_4_2 = new JLabel("Tomador:");
	...
	public TelaFinanceiroCadastroEmprestimo(int modo_operacao, Lancamento lancamento, Window janela_pai) {
		...
		rdbtnEmprestimo.setSelected(true);
		rdbtnEmprestimo.setFont(new Font("SansSerif", Font.PLAIN, 16));

		panel_1.add(rdbtnEmprestimo, "cell 2 1,alignx center");
		...
		painelAsPartes.add(painelDespesa, "cell 0 1 2 1,growx");
		...
		abas.addTab("O Mútuo", painelConta);
		...
		btnAtualizar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				boolean result = gerenciar.atualizarLancamento(lancamento_atualizar);
				if (result) {
		...
		btnCadastrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (result > 0) {
					...
					GerenciarBancoParcelasEmprestimo gerenciar_parcelas = new GerenciarBancoParcelasEmprestimo();
	...
	public void rotinasEdicao(Lancamento lancamento) {
		...
		lancamento.setTipo_lancamento(3); 
	...
	public Lancamento getDadosAtualizar(Lancamento lancamento_antigo) {
		...
		lancamento.setDescricao(descricao);
			...
			if (status == 0) {
				lancamento.setStatus(4);
			} else if (status == 1) {
				lancamento.setStatus(5);
			}
	...
	public void setPainelReceita() {
		...
		painelDespesa.setBackground(Color.WHITE);
		painelDespesa.setLayout(new MigLayout("", "[][grow][]", "[][][][][][][][][][][][][][][]"));
		painelDespesa.add(lblNewLabel_5, "cell 0 0");
		lblNewLabel_5.setVisible(false);
		lblNewLabel_5.setFont(new Font("SansSerif", Font.PLAIN, 18));
		lblNewLabel_4_2.setOpaque(true);
		lblNewLabel_4_2.setForeground(Color.WHITE);
		lblNewLabel_4_2.setFont(new Font("SansSerif", Font.BOLD, 18));
		lblNewLabel_4_2.setBackground(new Color(255, 102, 51));
		
		painelDespesa.add(lblNewLabel_4_2, "cell 0 1 3 1,growx");
		painelDespesa.add(lblNewLabel_3, "cell 0 2 3 1,growx");
		lblNewLabel_3.setOpaque(true);
		lblNewLabel_3.setBackground(new Color(255, 102, 51));
		lblNewLabel_3.setForeground(Color.WHITE);
		lblNewLabel_3.setFont(new Font("SansSerif", Font.BOLD, 18));
		painelDespesa.add(lblNewLabel_5_3, "cell 0 3");
		lblNewLabel_5_3.setVisible(false);
		lblNewLabel_5_3.setFont(new Font("SansSerif", Font.PLAIN, 18));
		painelDespesa.add(lblNewLabel_1_1, "cell 0 4,alignx right");
		lblNewLabel_1_1.setFont(new Font("SansSerif", Font.PLAIN, 16));
		painelDespesa.add(cbCliente, "cell 1 4,growx");
		cbCliente.setFont(new Font("SansSerif", Font.PLAIN, 16));
		...
		painelDespesa.add(btnSelecionar, "cell 2 4");

		btnSelecionar.setBackground(new Color(0, 0, 153));
		btnSelecionar.setForeground(Color.WHITE);
		painelDespesa.add(lblNewLabel_5_4, "cell 0 8");
		lblNewLabel_5_4.setVisible(false);
		lblNewLabel_5_4.setFont(new Font("SansSerif", Font.PLAIN, 18));
		painelDespesa.add(lblNewLabel_4, "cell 0 9 3 1,growx");
		lblNewLabel_4.setBackground(new Color(0, 153, 153));
		lblNewLabel_4.setOpaque(true);
		lblNewLabel_4.setForeground(Color.WHITE);
		lblNewLabel_4.setFont(new Font("SansSerif", Font.BOLD, 18));
		painelDespesa.add(lblNewLabel_5_5, "cell 0 10");
		lblNewLabel_5_5.setVisible(false);
		lblNewLabel_5_5.setFont(new Font("SansSerif", Font.PLAIN, 18));
		painelDespesa.add(lblNewLabel_1, "cell 0 11,alignx right");
		lblNewLabel_1.setFont(new Font("SansSerif", Font.PLAIN, 16));
		painelDespesa.add(cbCentroCusto, "cell 1 11,growx");
		cbCentroCusto.setFont(new Font("SansSerif", Font.PLAIN, 16));
		...
		painelDespesa.add(btnSelecionarCentroCusto, "cell 2 11");
