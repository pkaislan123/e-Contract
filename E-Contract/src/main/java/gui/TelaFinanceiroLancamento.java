...
public class TelaFinanceiroLancamento extends JFrame {
	...
	public TelaFinanceiroLancamento(int flag_modo_operacao, int flag_retorno, Window janela_pai) {
		...
		panel_1.setLayout(new MigLayout("", "[grow][grow][123px,grow][465px,grow][grow][grow][grow][][grow][grow]",
				"[31px,grow][][47px,grow][][][31px,grow][grow][grow][grow][]"));

		JLabel lblNewLabel_1_1_2_2 = new JLabel("ID Lançamento:");
		lblNewLabel_1_1_2_2.setFont(new Font("SansSerif", Font.PLAIN, 12));
		panel_1.add(lblNewLabel_1_1_2_2, "cell 0 0,alignx trailing");

		entIdLancamento = new JTextField();
		entIdLancamento.addKeyListener(new KeyAdapter() {
			@Override
			public void keyTyped(KeyEvent evt) {

				String caracteres = "0987654321\b";// lista de caracters que não devem ser aceitos
				String texto = entIdLancamento.getText();
		...
		panel_1.add(lblNewLabel_1_1_2, "cell 0 1,alignx trailing");
		...
		panel_1.add(lblNewLabel_1_1_2_1_1_2, "cell 0 3,alignx trailing");

		entIdentificadorGeral = new JTextField();
		entIdentificadorGeral.setColumns(10);
		panel_1.add(entIdentificadorGeral, "cell 1 3,growx");
		...
		panel_1.add(entDestinatarioNF, "cell 1 5,growx");

		JLabel lblNewLabel_1_1_2_1_1_1 = new JLabel("Contador:");
		lblNewLabel_1_1_2_1_1_1.setFont(new Font("SansSerif", Font.PLAIN, 12));
		panel_1.add(lblNewLabel_1_1_2_1_1_1, "cell 2 5,alignx trailing");

		cbStatusAoContador = new JComboBox();
		panel_1.add(cbStatusAoContador, "cell 3 5,growx");
	...
	public class LancamentoTableModel extends AbstractTableModel {
		...
		private final String colunas[] = { "ID", "Data Lançamento", "Tipo", "Prioridade", "Centro de Custo",
				"Identificador Geral", "Destinatário da NF", "Cliente/Fornecedor", "Grupo de Contas", "Conta",
				"Valor Total", "Valor Pago/Recebido", "Valor a Pagar/Receber", "Valor a Vencer", "Juros",
				"Data Próximo Vencimento", "Data Último Pagamento", "Status", "Situação", "Condições de Pagamento",
				"Status Condição de Pagamento", "Status Contador" };
