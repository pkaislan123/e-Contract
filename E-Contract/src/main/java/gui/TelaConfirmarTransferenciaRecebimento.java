...
public class TelaConfirmarTransferenciaRecebimento extends JDialog {

	private final JPanel painelPrincipal = new JPanel();
    private TelaConfirmarTransferenciaRecebimento isto;
	...
	public TelaConfirmarTransferenciaRecebimento(CadastroContrato contrato_remetente, JFrame janela_pai) {
	//	setModal(true);
