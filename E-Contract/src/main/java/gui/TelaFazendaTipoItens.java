...
public class TelaFazendaTipoItens extends JFrame {
	...
	public TelaFazendaTipoItens(int retorno_tela, Window janela_pai) {
	...
	public class TipoItensTableModel extends AbstractTableModel {
		...
		private final ArrayList<CadastroItem.Tipo> dados = new ArrayList<>();// usamos como dados uma lista genérica de
																				// nfs

		public TipoItensTableModel() {
		...
		public Object getValueAt(int rowIndex, int columnIndex) {
			CadastroItem.Tipo dado = dados.get(rowIndex);
		...
		public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
			CadastroItem.Tipo ib = dados.get(rowIndex);
		 ...
		 * @return
		 */
		public CadastroItem.Tipo getValue(int rowIndex) {
		 ...
		 * @return
		 */
		public int indexOf(CadastroItem.Tipo dado) {
		 ...
		 * @param empregado
		 */
		public void onAdd(CadastroItem.Tipo dado) {
			dados.add(dado);
		 ...
		 * @param dadosIn
		 */
		public void onAddAll(ArrayList<CadastroItem.Tipo> dadosIn) {
		 ...
		 * @param empregado
		 */
		public void onRemove(CadastroItem.Tipo dado) {
		...
		public CadastroItem.Tipo onGet(int row) {
