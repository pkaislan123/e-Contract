...
public class TelaContaBancaria extends JDialog {
	...
	private TelaContaBancaria isto;
	private JPopupMenu jPopupMenuContasBancarias;
	private JButton btnEditar;

	public  void pesquisar_contas() {
	...
	public TelaContaBancaria(Window janela_pai) {
		...
		painelPrincipal.setLayout(
				new MigLayout("", "[][][50px][10px][278px][49px][71px][14px][103px][12px][89px][10px][155px]",
						"[33px][33px][28px][grow][]"));
		...
		btnSelecionar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int indiceDaLinha = table_cb.getRowSorter().convertRowIndexToModel(rowSel);// converte pro indice do
																							// model
		...
		table_cb.getColumnModel().getColumn(2).setPreferredWidth(150);
		table_cb.getColumnModel().getColumn(3).setPreferredWidth(120);
		...
		btnEditar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				TelaEditarContaBancaria editar = new TelaEditarContaBancaria(contaSelecionada, isto);
	...
	public void setMenuContasBancarias() {
		...
		jMenuItemDetalhar.addActionListener(new java.awt.event.ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				ContaBancaria conta = modelo_cb.getValue(indiceDaLinha);
				TelaDetalharContaBancaria tela = new TelaDetalharContaBancaria(isto, conta);
		...
		table_cb.addMouseListener(new java.awt.event.MouseAdapter() {
			// Importe a classe java.awt.event.MouseEvent
			public void mouseClicked(MouseEvent e) {
				// Se o botão direito do mouse foi pressionado
				if (e.getButton() == MouseEvent.BUTTON3) {
					// Exibe o popup menu na posição do mouse.
					jPopupMenuContasBancarias.show(table_cb, e.getX(), e.getY());
				}
			}
		});
