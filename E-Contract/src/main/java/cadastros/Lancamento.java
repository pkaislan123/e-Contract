...
public class Lancamento {
	...
	int id_lancamento, contador,intervalo, id_detinatario_nf, prioridade, numero_parcelas, gerar_parcelas, tipo_lancamento, id_conta,status, id_instituicao_bancaria, id_centro_custo, id_cliente_fornecedor;
