...
public class GraficoMultiplaLinha {
	...
	public ChartPanel getGraficoLinha(int x, int y, String periodo, String titulo, String legenda_vertical, int padrao) {
		...
		JFreeChart xyChart = ChartFactory.createXYLineChart(titulo, periodo, legenda_vertical, dataSetGlobal,
