...
public class ComboBoxRenderPersonalizadoDepartamento extends DefaultListCellRenderer{
	 @Override
	    public Component getListCellRendererComponent(JList<? extends Object> list,
	            Object value, int index, boolean isSelected, boolean cellHasFocus) {
	        super.getListCellRendererComponent(list, value, index, isSelected, cellHasFocus);
	         
	        if (value instanceof CadastroFuncionarioDepartamentos) {
	        	CadastroFuncionarioDepartamentos cc = (CadastroFuncionarioDepartamentos) value;
	            setText(cc.getNome());
	        }
	        return this;
	    }
