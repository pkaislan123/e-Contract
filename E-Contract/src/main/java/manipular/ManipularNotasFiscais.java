...
public class ManipularNotasFiscais {
	...
	public CadastroNFe tratar_nfe_interna(String lines[], File file) {
		...
		/*
		 * if(procura_nfe.equals("") || procura_nfe == null) { procura_nfe =
		 * tratamentoDados.tratar("NFA-e","REMESSA"); if(procura_nfe.equals("") ||
		 * procura_nfe == null) { //procurar por outro tipo de nota procura_nfe =
		 * tratamentoDados.tratar("NFA-e","OUTRAS SAÍDAS"); if(procura_nfe.equals("") ||
		 * procura_nfe == null) { //System.out.println("Número NFA não encontrado"); }
		 * else { nfe = procura_nfe;
		 * 
		 * 
		 * 
		 * natureza = "OUTRAS SAÍDAS";
		 ...
		 * }
		 * 
		 * } else { nfe = procura_nfe; natureza = "REMESSA";
		 * 
		 * } } else { nfe = procura_nfe; natureza = "VENDA"; } nfe = nfe.replaceAll(",",
		 * "");
		 */
		// String nfe = lines[27].toString().replaceAll("[^0-9]+", "");
		...
		/*
		 * String nome_remetente = null; if(natureza.equals("VENDA")) { nome_remetente =
		 * tratamentoDados.tratar("VENDA,", ","); nome_remetente =
		 * nome_remetente.replaceAll("[^a-zA-Z ]", "");
		 * 
		 * } if(natureza.equals("REMESSA")) { nome_remetente =
		 * tratamentoDados.tratar("REMESSA,", ","); nome_remetente =
		 * nome_remetente.replaceAll("[^a-zA-Z ]", "");
		 * 
		 * } if(natureza.equals("OUTRAS SAÍDAS")) { nome_remetente =
		 * tratamentoDados.tratar("OUTRAS SAÍDAS,", ","); nome_remetente =
		 * nome_remetente.replaceAll("[^a-zA-Z ]", "");
		 * 
		 * }
		 * 
		...
		try {
			...
			// JOptionPane.showMessageDialog(null, "Erro ao listar NF-e interna
			// sucess\nErro: " + t.getMessage() + "\nConsulte o Administrador");
	...
	public CadastroNFe tratar_nfe_interna_siacon(String lines[], File file) {
		...
		try {
			...
			//// JOptionPane.showMessageDialog(null, "linha info dest: " +
			//// linha_com_info_destinatario);
			// quebrar string
			...
			try {
				...
				// JOptionPane.showMessageDialog(null, "Erro ao ler nota fiscal interna
				// siacon\nErro: " + t.getMessage() + "\nConsulte o Administrador");
	...
	public CadastroNFe tratar_nfe_cj(String lines[], File file) {
		...
		// JOptionPane.showMessageDialog(null, "Inscrição do remetente: " +
		// insc_remetente);
		...
		try {
			...
			// JOptionPane.showMessageDialog(null, "Erro ao listar data NFA da CJ
			// Selecta\nErro: " + t.getMessage() + "\nConsulte o Administrador");
			return null;
		}
		...
		// JOptionPane.showMessageDialog(null, "inscricao destinatario: " +
		// insc_destinatario);
	...
	public CadastroNFe tratar_nfe_interna_gescoop(String lines[], File file) {
		...
		CadastroNFe cadastro = new CadastroNFe();
		cadastro.setCaminho_arquivo(file.getAbsolutePath());
		// JOptionPane.showMessageDialog(null, "Nf gescoop encontrada, caminho: " +
		...
		try {
			...
			// JOptionPane.showMessageDialog(null, "Codigo nfe gescoop: " +
			// cadastro.getNfe());
			...
			cadastro.setProduto(produto);
			/*
			 * //tratamento da quantidade String quantidade = "";
			 * if(tratar.contains("5905")) { if(tratar.contains("KG")) {
			 * cadastro.setMedida("KG"); quantidade = tratamentoDados.tratar("5905 KG ",
			 * " ").trim(); quantidade = quantidade.substring(0, quantidade.length() - 1);
			 * }else if(tratar.contains("SC")) { cadastro.setMedida("Sacos"); quantidade =
			 * tratamentoDados.tratar("5905 SC ", " ").trim(); quantidade =
			 * quantidade.substring(0, quantidade.length() - 1);
			 * 
			...
			// JOptionPane.showMessageDialog(null, "Erro ao processar daos da nf interna
			// gescoop\nErro: " + t.getMessage() + "\nCausa: " + t.getCause());
			CadastroAviso avisar = new CadastroAviso();
