...
public class GerenciarBancoFinanceiroPagamento {
    public String sql_dado(FinanceiroPagamento dado) {
        return "insert into financeiro_pagamento (id_lancamento_pai, identificador,tipo_pagador, id_pagador, tipo_recebedor,id_recebedor, id_forma_pagamento, status_condicao_pagamento, valor, data_pagamento,fluxo_caixa,observacao, descricao,caminho_arquivo, extrato_bancario , tipo_pagamento) values ('" + dado.getId_lancamento() + "','" + dado.getIdentificador() + "','" + dado.getTipo_pagador() + "','" + dado.getId_pagador() + "','" + dado.getTipo_recebedor() + "','" + dado.getId_recebedor() + "','" + dado.getId_condicao_pagamento() + "','" + dado.getStatus_pagamento() + "','" + dado.getValor() + "','" + dado.getData_pagamento() + "','" + dado.getFluxo_caixa() + "','" + dado.getObservacao() + "','" + dado.getDescricao() + "','" + dado.getCaminho_arquivo() + "','" + dado.getExtrato() + "','" + dado.getTipo_pagamento() + "')";
    }
    ...
    public ArrayList<FinanceiroPagamento> getFinanceiroPagamentos() {
        ...
        ResultSet rs = null;
        ArrayList<FinanceiroPagamento> lista = new ArrayList<FinanceiroPagamento>();
        try {
            conn = ConexaoBanco.getConexao();
    ...
    public ArrayList<FinanceiroPagamentoCompleto> getFinanceiroPagamentosPorLancamentoParaRelatorio(int id_lancamento) {
        ...
        PreparedStatement pstm = null;
        ResultSet rs = null;
        ArrayList<FinanceiroPagamentoCompleto> lista = new ArrayList<FinanceiroPagamentoCompleto>();
        try {
            conn = ConexaoBanco.getConexao();
            pstm = conn.prepareStatement(select);
            pstm.setInt(1, id_lancamento);
    ...
    public boolean removerFinanceiroPagamento(int id) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Erro ao excluir o Financeiro Pagamento do banco de dados\nBanco de dados corrompido!\nConsulte o administrador do sistemadados " + f.getMessage());
            return false;
        }
    }
    ...
    public boolean atualizarFinanceiroPagamento(FinanceiroPagamento dado) {
        if (dado != null) {
            try {
                ...
                atualizar = "update financeiro_pagamento set identificador = ? , tipo_pagador = ?, id_pagador = ?, tipo_recebedor = ?, id_recebedor = ?, id_forma_pagamento = ?, status_condicao_pagamento = ?, valor = ?, data_pagamento = ?, fluxo_caixa = ?, observacao = ?, descricao = ? , extrato_bancario = ? where id_pagamento = ?";
                conn = ConexaoBanco.getConexao();
    ...
    public ArrayList<FinanceiroPagamentoCompleto> getFinanceiroPagamentosLancamentos() {
        ...
        try {
            ...
            rs = pstm.executeQuery();
            while (rs.next()) {
                if (rs.getInt("id_lancamento") <= 0) continue;
                FinanceiroPagamento dado = new FinanceiroPagamento();
                dado.setId_pagamento(rs.getInt("id_pagamento"));
                dado.setId_lancamento(rs.getInt("id_lancamento_pai"));
                dado.setIdentificador(rs.getString("identificador"));
    ...
    public ArrayList<FinanceiroPagamentoCompleto> getTodosFinanceiroPagamentosFiltrados(int cc, int ib, int mes, int ano, int tipo) {
    ...
    public SaldoInstituicaoBancaria getSaldoPorPeriodoInicial(int id_instituicao_bancaria, String data) {
        String select = "call busca_saldo_periodo_inicial(?, ?)";
        Connection conn = null;
        PreparedStatement pstm = null;
        SaldoInstituicaoBancaria saldo = new SaldoInstituicaoBancaria();
        ResultSet rs = null;
        try {
            ...
            saldo.setTotal_receita_transferencia(rs.getDouble("total_receita_transferencia"));
            saldo.setTotal_despesa_transferencia(rs.getDouble("total_despesa_transferencia"));
            System.out.println("Total de Despesa Normal: " + saldo.getTotal_despesa());
            System.out.println("Total de Despesa Emprestimo: " + saldo.getTotal_despesa_emprestimo());
            System.out.println("Total de Despesa Transferecnia: " + saldo.getTotal_despesa_transferencia());
            System.out.println("Total de Despesas : " + (saldo.getTotal_despesa() + saldo.getTotal_despesa_emprestimo() + saldo.getTotal_despesa_transferencia()));
            System.out.println("Total de Receita Normal: " + saldo.getTotal_receita());
            System.out.println("Total de Receita Emprestimo: " + saldo.getTotal_emprestimos());
            System.out.println("Total de Receita Transferecnia: " + saldo.getTotal_receita_transferencia());
            System.out.println("Total de Receitas : " + (saldo.getTotal_receita() + saldo.getTotal_emprestimos() + saldo.getTotal_receita_transferencia()));
            ConexaoBanco.fechaConexao(conn, pstm, rs);
            return saldo;
        }
        catch (Exception e) {
