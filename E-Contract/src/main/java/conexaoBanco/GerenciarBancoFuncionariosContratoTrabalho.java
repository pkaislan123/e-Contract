...
/*
 *CREATE TABLE `funcionario_contrato_trabalho` (
  `id_contrato` int(3) NOT NULL AUTO_INCREMENT,
   `status` int(3) not null, 
  `data_admissao` varchar(40) DEFAULT NULL,
 ...
 */
	...
	public String sql_ContratodeTrabalho(CadastroFuncionarioAdmissao contrato) {
		return "insert into funcionario_contrato_trabalho (id_colaborador, status, data_admissao, tipo_contrato,cargo,funcao,salario) values ('"
				+ contrato.getId_colaborador() + "','"
				+ contrato.getStatus() + "','"
				+ contrato.getData_admissao() + "','"
              ...
              PreparedStatement pstm;
	            ...
	            try {
	              ...
	              return true;
	                ...
	                JOptionPane.showMessageDialog(null, "Erro ao atualizar o contrato no banco de"
	                        + "dados "  );
	                return false;
	            }
	        } else {
