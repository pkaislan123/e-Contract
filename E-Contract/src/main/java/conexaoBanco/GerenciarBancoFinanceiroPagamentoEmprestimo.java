...
public class GerenciarBancoFinanceiroPagamentoEmprestimo {
    public String sql_dado(FinanceiroPagamentoEmprestimo dado) {
        return "insert into financeiro_pagamento_emprestimo (id_lancamento_pai, identificador,tipo_pagador, id_pagador,tipo_recebedor, id_recebedor, id_forma_pagamento, status_condicao_pagamento,  objeto, especie, quantidade, unidade_medida, valor_unitario,valor_total, data_pagamento,fluxo_caixa,observacao, descricao,caminho_arquivo, extrato_bancario ) values ('" + dado.getId_lancamento() + "','" + dado.getIdentificador() + "','" + dado.getTipo_pagador() + "','" + dado.getId_pagador() + "','" + dado.getTipo_recebedor() + "','" + dado.getId_recebedor() + "','" + dado.getId_condicao_pagamento() + "','" + dado.getStatus_pagamento() + "','" + dado.getObjeto() + "','" + dado.getEspecie() + "','" + dado.getQuantidade() + "','" + dado.getUnidade_medida() + "','" + dado.getValor_unitario() + "','" + dado.getValor() + "','" + dado.getData_pagamento() + "','" + dado.getFluxo_caixa() + "','" + dado.getObservacao() + "','" + dado.getDescricao() + "','" + dado.getCaminho_arquivo() + "','" + dado.getExtrato() + "')";
    }
    ...
    public ArrayList<FinanceiroPagamentoEmprestimo> getFinanceiroPagamentos() {
        ...
        ResultSet rs = null;
        ArrayList<FinanceiroPagamentoEmprestimo> lista = new ArrayList<FinanceiroPagamentoEmprestimo>();
        try {
            conn = ConexaoBanco.getConexao();
    ...
    public ArrayList<FinanceiroPagamentoEmprestimoCompleto> getFinanceiroPagamentosPorLancamentoParaRelatorio(int id_lancamento) {
        ...
        PreparedStatement pstm = null;
        ResultSet rs = null;
        ArrayList<FinanceiroPagamentoEmprestimoCompleto> lista = new ArrayList<FinanceiroPagamentoEmprestimoCompleto>();
        try {
            conn = ConexaoBanco.getConexao();
            pstm = conn.prepareStatement(select);
            pstm.setInt(1, id_lancamento);
    ...
    public boolean atualizarFinanceiroPagamento(FinanceiroPagamentoEmprestimo dado) {
        if (dado != null) {
            try {
                ...
                atualizar = "update financeiro_pagamento_emprestimo set identificador = ? ,tipo_pagador = ?, id_pagador = ?, tipo_recebedor = ?, id_recebedor = ?, id_forma_pagamento = ?, status_condicao_pagamento = ?, objeto = ?,especie = ?,quantidade = ?,unidade_medida = ?,valor_unitario = ?,valor_total = ?, data_pagamento = ?, fluxo_caixa = ?, observacao = ?, descricao = ? , extrato_bancario = ? where id_pagamento =?";
                conn = ConexaoBanco.getConexao();
    ...
    public ArrayList<FinanceiroPagamentoCompleto> getTodosFinanceiroPagamentosEmprestimos() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Erro ao listar Todos os Financeiro Pagamento de Emprestimo\nErro: " + e.getMessage() + "\nCausa: " + e.getCause());
        }
        return lista;
    }

    public ArrayList<FinanceiroPagamentoCompleto> getTodosFinanceiroPagamentosEmprestimosFiltratos(int cc, int ib, int mes, int ano, int tipo) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Erro ao listar Todos os Financeiro Pagamento de Emprestimo Filtrados\nErro: " + e.getMessage() + "\nCausa: " + e.getCause());
        }
        return lista;
    }
