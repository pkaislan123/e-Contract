		...
		if (acesso != null) {
			...
			try {
				...
				String sql = "insert into acesso_temporario\r\n"
						...
						+ acesso.getId_usuario_criador() + "','" + acesso.getId_usuario_executor() + "','"
						+ acesso.getData_inicial() + "','" + acesso.getHora_inicial() + "','" + acesso.getData_final()
						+ "','" + acesso.getHora_final() + "','" + acesso.getModulo() + "')";
