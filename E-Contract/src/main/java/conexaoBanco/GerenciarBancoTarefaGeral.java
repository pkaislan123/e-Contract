...
public class GerenciarBancoTarefaGeral {
	...
	public String sql_tarefa(CadastroTarefaGeral tarefa) {
		...
		String query = "insert into tarefa_geral (status_tarefa, nome_tarefa, descricao_tarefa , mensagem, hora, data_tarefa, id_usuario_criador, id_usuario_executor, hora_agendada, data_agendada, prioridade, tipo, id_lancamento_pai) values ('"
