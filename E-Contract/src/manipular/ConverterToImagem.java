...
public class ConverterToImagem {
	
	
	public String to_img(String sourceDir) {
		try {
            String destinationDir = "C:\\ProgramData\\E-Contract\\temp_files\\"; // converted images from pdf document are saved here
            ...
            if (sourceFile.exists()) {
                ...
                for (int i = 0; i < numberOfPages; ++i) {
                    File outPutFile = new File(destinationDir + "convertido" + "." + fileExtension);
                ...
                return destinationDir + "convertido" + "." + fileExtension;
            } else {
