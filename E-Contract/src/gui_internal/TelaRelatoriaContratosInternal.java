...
public class TelaRelatoriaContratosInternal extends JInternalFrame {
	...
	public TelaRelatoriaContratosInternal() {

		TelaRelatoriaContratosInternal isto = this;
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (gerar && chkBoxContratosComoComprador.isSelected()) {
					...
					TelaVizualizarPdf vizualizar = new TelaVizualizarPdf(null, null, null, pdf_alterado, null, null);
					...
					RelatorioContratos relatar = new RelatorioContratos(tipo_contrato, contrato, false, pagamento,
							...
							carregamento_como_comprador, carregamento_como_vendedor, id_safra, sub_contratos,
		...
		btnNewButton.setBounds(690, 545, 89, 23);
