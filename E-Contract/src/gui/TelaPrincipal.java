...
public class TelaPrincipal extends JFrame implements GetDadosGlobais {
	...
	public TelaPrincipal() {
		...
		contentPane.setLayout(new MigLayout("", "[369px,grow][10px][463px][20px][64px][83.00px][83.00px][5px][6px][18.00px][26px][64.00px][27px][97.00px][101px][52.00px][109px]", "[56px][][8px][3px][26px][16px][256px][2px][23px][10px][280px][grow]"));
		
				JLabel lblNewLabel_4 = new JLabel("tarefas");
				contentPane.add(lblNewLabel_4, "cell 11 1,grow");
		...
		contentPane.add(lblDireitos, "cell 14 1 3 1");

		panelGraficoLinha = new JPanel();

		panelGraficoLinha.setBackground(Color.WHITE);

		contentPane.add(panelGraficoLinha, "cell 0 10,grow");
		...
		contentPane.add(menuBar, "cell 0 0 3 1,grow");
		...
		contentPane.add(lblUser, "cell 14 0 3 1,alignx left,aligny center");
		...
		contentPane.add(painelInfoConexao, "cell 13 6 4 1,grow");
		...
		contentPane.add(btnSair, "cell 16 4,growx,aligny bottom");
		...
		panel_2.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				if (telaChat == null) {
					...
					telaChat.mostrar(getIndexTelaPai());
		...
		contentPane.add(panel_2, "cell 13 10 4 1,growx,aligny bottom");
		panel_2.setLayout(new MigLayout("", "[][32px][161px]", "[32px]"));
		
		JLabel lblNewLabel_9 = new JLabel("mesangem");
		lblNewLabel_9.setVisible(false);
		panel_2.add(lblNewLabel_9, "cell 0 0");
		...
		cbContratosPorSafra.setBounds(515, 41, 357, 34);
		...
		lblNewLabel_6.setBounds(515, 11, 357, 22);
		...
		contentPane.add(lblNewLabel_1, "cell 6 0 1 3,alignx left,aligny top");

		JLabel lblNewLabel_2 = new JLabel("Você tem:");
		contentPane.add(lblNewLabel_2, "cell 6 0 1 3,alignx center,growy");

		lblNumeroTarefas = new JLabel("0");
		lblNumeroTarefas.setFont(new Font("Tahoma", Font.BOLD, 18));
		contentPane.add(lblNumeroTarefas, "cell 8 0 3 3,growx,aligny bottom");
		...
		contentPane.add(lblNewLabel_5_1, "cell 0 7 17 1,grow");

		JPanel panel = new JPanel();
		panel.setBackground(Color.WHITE);
		contentPane.add(panel, "cell 1 8 14 3,grow");
		panel.setLayout(new MigLayout("", "[689.00px][326px][][][]", "[33px][11px][36.00][243px]"));

		painelGraficoCarregamentos = new JPanelGraficoCarregamento(0, 0);
		painelGraficoCarregamentos.setLayout(null);
		panel.add(painelGraficoCarregamentos, "cell 0 0 2 4,grow");
		...
		lblNewLabel_5.setBounds(408, 60, 64, 64);
		...
		lblNewLabel_5.setIcon(new ImageIcon(TelaPrincipal.class.getResource("/imagens/icone_caminhao.png")));
																		...
																		panel.add(lblNewLabel_6_1, "cell 2 0 3 1,growx,aligny bottom");
																...
																cbCarregamentoPorSafra.setAlignmentY(Component.BOTTOM_ALIGNMENT);
																panel.add(cbCarregamentoPorSafra, "cell 2 1 3 2,growx,aligny top");
		...
		contentPane.add(lblNewLabel_8, "cell 4 0 1 3,alignx left,aligny top");
